...
from .diffusion_down_roi_head import DiffusionDownRoIHead
from .diffusion_merge_roi_head import DiffusionMergeRoIHead
...
__all__ = [
    ...
    'FeatureRelayHead', 'GlobalContextHead', 'DiffusionDownRoIHead',
    'DiffusionMergeRoIHead'
]
